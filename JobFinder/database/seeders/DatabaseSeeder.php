...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // DB::table('jobcategory')->insert(["Category" => "API"]);
        // job::factory(8)->create();
        // DB::table('jobcategory')->insert(["Category" => "PHP"]);
        // DB::table('jobcategory')->insert(["Category" => "C#"]);

        // DB::table('jobcategory')->insert(["Category" => "Python"]);
        // DB::table('jobcategory')->insert(["Category" => "Javascript"]);
        // DB::table('jobcategory')->insert(["Category" => "Node"]);
            // DB::table('jobcategory')->insert(["Category" => "PHP"]);
